...
class HelloCdkStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, env) -> None:
        ...
        for i in range(0, 2):
            ec2.CfnRoute(self, route_name + str(i),
        ...
        for i in range(0, 2):
            ec2.CfnRoute(self, second_route_name + str(i),
        ...
        for i in range(0, 2):
            ec2.CfnRoute(self, third_route_name + str(i),
        ...
        web_key.grant_read_on_private_key(asg.role)
        web_key.grant_read_on_public_key(asg.role)
        ...
        # add load balancer to the webserver.
        ...
        mm_key.grant_read_on_private_key(ManagementServer.role)
        mm_key.grant_read_on_public_key(ManagementServer.role)
