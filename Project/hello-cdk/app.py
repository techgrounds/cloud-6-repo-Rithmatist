...
from hello_cdk.pipeline_stack import WorkshopPipelineStack
...
app = cdk.App()
WorkshopPipelineStack(app, "workshop-pipeline", env=cdk.Environment(account='600563666729', region='eu-central-1'))
